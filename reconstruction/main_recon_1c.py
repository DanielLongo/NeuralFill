...
run_filename = find_valid_filename("1c_s_all", HOME_PATH + 'reconstruction/runs/')
...
if __name__ == "__main__":
    ...
    writer.close()
        ...
        # save_gens_samples(model, save_filename, params["z_dim"], n_samples=16)
